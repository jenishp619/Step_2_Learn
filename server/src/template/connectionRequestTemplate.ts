  ...
  return `
    ...
    >
      <head>
        ...
        <title>Welcome to StepToLearn</title>
        <!--[if (mso 16)]>
          <style type="text/css">
            a {
              ...
              <td style="padding: 0; margin: 0">
                ...
                >
                  <tr style="border-collapse: collapse">
                    ...
                    >
                      <img
                        src="https://rjkeuc.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
                        style="
                          display: block;
                          border: 0;
                          outline: none;
            ...
            <tr style="border-collapse: collapse">
              <td valign="top" style="padding: 0; margin: 0">
                ...
                >
                  <tr style="border-collapse: collapse">
                    <td
                      style="padding: 0; margin: 0; background-color: #ffa73b"
                      bgcolor="#ffa73b"
                      align="center"
                    >
                      <table
                                    ...
                                    <tr style="border-collapse: collapse">
                                      ...
                                      >
                                        <p
                                          ...
                                          "
                                        >
                                          ${firstName} ${lastName} has sent you a connection request<br />
                                        </p>
                                      </td>
                                    </tr>
                                    <tr style="border-collapse: collapse">
                                      ...
                                      >
                                        <span
                                          ...
                                          "
                                          ><a
                                            href="https://group-18.netlify.app/profile/${id}"
                                  ...
                                  >
                                    ...
                                    <tr style="border-collapse: collapse">
                                      ...
                                      >
                                        <a
                                          target="_blank"
                                          href="https://group-18.netlify.app"
                                          style="
                                            -webkit-text-size-adjust: none;
                                            -ms-text-size-adjust: none;
                                            mso-line-height-rule: exactly;
